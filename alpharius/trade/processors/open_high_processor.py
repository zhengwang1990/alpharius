...
class OpenHighProcessor(Processor):
    ...
    def _open_position(self, context: Context) -> Optional[ProcessorAction]:
        ...
        if drop > threshold:
            self._positions[context.symbol] = {'entry_time': context.current_time, 'status': 'pending'}
    ...
    def _close_position(self, context: Context) -> Optional[ProcessorAction]:
        ...
        is_close = (
            stop_loss
            or context.current_time >= position['entry_time'] + datetime.timedelta(minutes=15)
